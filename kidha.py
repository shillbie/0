...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token='EoUHqgYzxVqWBdlm1DLb.wvTH9/seZu9vDRNQs/ArwW.SMd+qrizFZ5iwhwngs11FyGoOdPA1M5/VYF9TDjZ0Ec=')#chery
kr.loginResult()
...
Bots=[mid]
owner=["ub7b31fa9b33f809672a40a98425f59e8",mid]
admin=["ub7b31fa9b33f809672a40a98425f59e8",mid]
baby=["ub7b31fa9b33f809672a40a98425f59e8"]#chery/barby/ranita
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['kickMention'] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","saya sendiri lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
                       ...
                       for target in targets:
                            try:
                               ...
                               kr.sendText(msg.to, "Copied.")
                                ...
                                print e
            elif msg.text in ["Semula","mybackup"]:
                try:
