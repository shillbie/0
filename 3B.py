...
cl = LINETCR.LINE()
cl.login(token="EogNPqCKwdrqEAi9NBib.w6++hcW.AAtArKLqrocrUu3ZEt+hQb2U2jWDcdba4hwEEmGI0Us=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoGgEDm4fbXITsuDj1h3..ncD5Ivv9vavi+zsYZ4KuHdQCRI6bGpLUy3o74jvAqGg=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EoA0Mxh1UUYSV8NbB2w1.wOe3+.uJ92ObzaBk8AGBqNEO7X/aPyR1sNXpWz1bsol4HPpxs=")
ki2.loginResult()
