...
cl = LINETCR.LINE() 
#cl.login(qr=True)
cl.login(token="EopQLp2TOHZK5WnAHBXd.t9bOCFBZsWK6oxk4TD6ppq.p08XnEOdqaYL/p2nmOe62vcDPxW1CRDGlvK4qb77Jk0=")
cl.loginResult()

ki = LINETCR.LINE() 
#ki.login(qr=True)
ki.login(token="EoARmmuN1JLSlobKIQ56.DJfCP5tT35HajOsEmvX6PG.iVv5WH9WAcglI/AF24aeluFlA8pgDZ3vOLtxJ7+Q+fQ=")
ki.loginResult()

kk = LINETCR.LINE() 
#kk.login(qr=True)
kk.login(token="EoOsT5Im3aeaenoz9oe0.B7g9A1RW8NU9Ui7lAHrOWa.1bdVE33FUwUzYZqSDWE+0npwYTL4YgY0YMAXi1R7jYg=")
kk.loginResult()

kc = LINETCR.LINE() 
#kc.login(qr=True)
kc.login(token="EoikgJu3oO80UcYObef6.PARWLiQ1yX8Ge7Tqgg1FbG.hSFsmHgX1HKZHXToTk2pNcPeuer+xOL2OLQsCQD9YR4=")
kc.loginResult()

ks = LINETCR.LINE() 
#ks.login(qr=True)
ks.login(token="EojEE7DCamfJbnqxMXca.+swELSmclJDdUyMkvoatAG.w8W0+mGyAPY42as6VoTL6W3oMpto1uOmaY8gBtvjpn8=")#5
ks.loginResult()

k1 = LINETCR.LINE() 
#k1.login(qr=True)
k1.login(token="EogMbf7aoMYOIHcjUxoa.ofPkasavZhLKD4OwvrsSMG.vdO18fDElP0YW9/56uUuDWOj53FgTcfKOeu4J6TX0eQ=")#6
k1.loginResult()

k2 = LINETCR.LINE() 
#k2.login(qr=True)
k2.login(token="EoRnVHEm7Qx6szji9mC9.Eh+xAjKRse5Gp+veh562Mq.BaM+/eO/u5S2DMCfGoLlyYJTxTZxJw6VPfeNfjjK+2s=")#7
k2.loginResult()

k3 = LINETCR.LINE() 
#k3.login(qr=True)
k3.login(token="EolIkRnKspnErrctEOad.qcJOSgzQEpbuah+2LTD5Bq.2LPSqzMhmtKE/79QAOAKFq1kcBovX/fSYwhGjqohGQk=")#8
k3.loginResult()

k4 = LINETCR.LINE() 
#k4.login(qr=True)
k4.login(token="EoFdasaFX7IskJMeUx9c.64p7hMq5ZbXymY+T0gu3Na.4ysgO9fPsGV4wPh0RpxO7J5ugKNjqCuPWdHD1jxgzGs=")#9
k4.loginResult()

k5 = LINETCR.LINE() 
#k5.login(qr=True)
k5.login(token="EozunpB0lDmk9xgTpZrb.j0tevqX/kt6xRCOKoax7sW.JTXjm0hTHZyPV2H08hd9i5MAIbKgIT+pd84Gf9+eXFI=")#10
k5.loginResult()

satpam1 = LINETCR.LINE()  
satpam1.login(token="EoGsXFRxjxlKq16ydcG3.m5X5B34I0MLNJSqaZLZ5uW.BiYMEN+pGTbpSK00B3IwWOBZ79jBVLo4l2UrhaN8UK4=")#11
...
admin=["u5baffcc81a0a0689982216a005cfc70b","u246cb4d9c8a981d4299b7ef16cad49d9","u76315ca794eddf984026849e315c7aa6","u01800554d8ba8c353be01aab85de9110","ufad6050bc087e1492034e7cdfb061320","u944c5e70a6302e1a2fe0900c864691d4","u246cb4d9c8a981d4299b7ef16cad49d9","uc8e1e36f976e5f4e15e64d9d1cbe1878","ub34b6b9a9ce7d7fca99460477fd3fcf3","udd917e76596789ae636e53342f37f78c","u15be3f8d6ff7f0e53e4cc8bb30c4fa18","u339c796f7e22d269678ec400ce5cf953","u940947814c50be1fed29c901beed59e1","u31a54e26da314829c76fa084730dae76","ub7b31fa9b33f809672a40a98425f59e8","u595b61f7e484cd4f5576b9ea4be6915b",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid1] #RHna,RH,
...
#--------------------------------------------------------
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin ✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰||\n=====================\n"
                  for mi_d in admin:
...
#---------------------Sc invite owner ke group------
            elif "Masukin: " in msg.text:
              if msg.from_ in owner:
                gid = msg.text.replace("Masukin: ","")
                if gid == "":
...
#=================================================
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to, "ini dia tukang ngintip")
                try:
            ...
            elif msg.text == "ini dia tukang ngintip":
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : ✰ই͜͜͡☬i̺͆y̺͆o̺͆😎✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆  ✰     ||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, "✔ ✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰\nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Melebu","Kr asup","Asup"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["bye bot","Ampih"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#----------------------------[Spam To Contact]----------------------------#WORK 
              ...
              if msg.from_ in owner:
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       ...
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       cl.sendText(g.mid,"ada yang cari tuh bos di grup...")
                       kk.sendText(g.mid,"bruan cuy... liat grup...")
                       kk.sendText(g.mid,"bruan cuy... liat grup...")
                       kk.sendText(g.mid,"bruan cuy... liat grup...")
                       kk.sendText(g.mid,"bruan cuy... liat grup...")
                       kk.sendText(g.mid,"bruan cuy... liat grup...")
                       ...
                       k1.sendText(g.mid,"Masuk Room Woy...!!!")
                       k1.sendText(g.mid,"Masuk Room Woy...!!!")
                       cl.sendText(msg.to, "udah ku panggil bos...!!!")
                       kk.sendText(msg.to, "kalo gk nongol cipok aja...!!!")
                       k1.sendText(msg.to, "biar tau rasa...!!!")
                       print " Spammed !"
#----------------------------[Spam To Contact]----------------------------#WORK 
       #--------------------Start-----------------------#       
            ...
            elif "Berapa banyak dosa " in msg.text:
                tanya = msg.text.replace("Berapa banyak dosa ","")
                jawab = ("0%\nAnak yg rajin ibadah😘😘😘","25%","50%\nCepat~cepat tobat nak!!!😡","75%\nLekas lah tobat nak sebelum ajal menjemputmu","100%\nKm gk pantas masuk syurga karna dosamu... dh gak ke itung!!! 👺")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)                
                kk.sendText(msg.to,jawaban)		                
                kk.sendText(msg.to,jawaban)		                
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Obot","Bot kadieu","Bot arampih"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#=======================================
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       ...
                       pass
            elif "InCopy @" in msg.text:
                if msg.toType == 2:
                    if msg.from_ in admin:
                        print "[COPY] Ok"
                        _name = msg.text.replace("InCopy @","")
                        _nametarget = _name.rstrip('  ')
                        gs = cl.getGroup(msg.to)
                        targets = []
                        for g in gs.members:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    cl.sendText(msg.to, "Sukses induk Copy Profile")
                                except Exception as e:
                                    print e
            elif "Assist @" in msg.text:
                if msg.toType == 2:
                    if msg.from_ in admin:
                        print "[COPY] Ok"
                        _name = msg.text.replace("Assist @","")
                        _nametarget = _name.rstrip('  ')
                        gs = ki.getGroup(msg.to)
                        targets = []
                        for g in gs.members:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    k4.CloneContactProfile(target)
                                    k5.CloneContactProfile(target)
                                    cl.sendText(msg.to, "Sukses Assist Copy Profile")
                                except Exception as e:
                                    print e                                    
              ...
              if msg.from_ in admin:
                ...
                try:
                    ...
                    try:
                        ...
                        pass
#--------------------------------------------------------
	    elif "Bascamp" in msg.text:
		thisgroup = cl.getGroups([msg.to])
		Mids = [contact.mid for contact in thisgroup[0].members]
		mi_d = Mids[:33]
		cl.createGroup("Bascamp", mi_d)
		cl.sendText(msg.to,"Success buat grup bascamp")
#--------------------------------------------------------
#--------------------------------------------------------
...
#                cl.sendText(msg.to,jawaban)
            ...
            try:
                tanya = msg.text.replace("@"+cl.getProfile().displayName,"")
                jawab = ("Jgn Tag Si "+cl.getProfile().displayName+"sesuai peraturan yang tag "+cl.getProfile().displayName+" akan kami keluarkan dari grup \ndia keamanan disni \nmaaf anda kami kick")
                jawaban = random.choice(jawab)
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    k1.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    k2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    k3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By✰ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰😊\n\n☆º°˚˚☆ ✰ S̺͆T̺͆A̺͆R̺͆ B̺͆O̺͆T̺͆S̺͆ ✰      ✰°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by RH ⭐👈 »»» http://line.me/ti/p/VxtJPseezK «««")
                    print "Like"
                except:
                    pass
            else:
