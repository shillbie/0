...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Eo9HzOpxM1EeMhicxpl0.F4TGaftJCWVH+qiLum3X4a.zElChnAWpSVKNvUT4dbLALO4QdX4PXO0YtbDuH4S+7k=')#chery
kr.loginResult()
...
Bots=[mid]
owner=["u7f8b600054e3730be1fd022550cdf1e0",mid]
admin=["u7f8b600054e3730be1fd022550cdf1e0",mid]
baby=["u7f8b600054e3730be1fd022550cdf1e0"]#chery/barby/ranita
