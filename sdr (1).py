...
╠➩〘Help media〙
╠+++++++++++++++++++++++++
╠➩  undang  aku ke grup lain y kak..
╠➩  aku hanya bot sider
╠➩  tidak berbahaya.... ketik Sider on
╠➩   
╠➩   haya sekedar untuk hiburan
╠➩   thanks......
╠➩
╠═════════════════════════
║          id line: ☄i̺͆y̺͆o̺͆😎
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ...
                kr.sendText(msg.to,"TC9 Hadiir  \(ˆ▿ˆ)/")
...
#----------------------------------------------------------
                ...
                cl.sendText(msg.to,"jangan suka tag2 orang kk, kasian tau") 
                ...
                cl.sendText(msg.to,"eleh kk mah modus")
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        if targets == []:
                            ...
                            kk.sendText(msg.to,"coba lagi besok.")
                            kc.sendText(msg.to,"ok!!!.")
                        else:
                            for target in targets:
				if target not in admin:
                                    try:
                                        klist=[ki,kk,kc,ku,ko,kb,kd,ke]
                                        kicker=random.choice(klist)
